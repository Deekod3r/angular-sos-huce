...
import {AccessDeniedComponent} from '../modules/errors/access-denined/access-denied.component';
...
import {NewsMediaComponent} from '../modules/admin/news-media/news-media.component';
...
export let ROUTES_ADMIN: Routes = [
    ...
    {path: 'tin-tuc', component: NewsMediaComponent},
