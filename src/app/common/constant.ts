...
export const REGEX = {
    ...
    CHARACTER: /^[a-zA-ZưứừữựửƯỨỪỮỰỬéèẽẹẻÉÈẼẸẺếềễệểẾỀỄỆỂýỳỹỵỷÝỲỸỴỶúùũụủÚÙŨỤỦíìĩịỉÍÌĨỊỈóòõọỏÓÒÕỌỎôốồỗộổÔỐỒỖỘỔơớờỡợởƠỚỜỠỢỞáàãạảÁÀÃẠẢâấầẫậẩÂẤẦẪẬẨăắằẵặẳĂẮẰẴẶẲđĐ ]{1,}$/,
}
