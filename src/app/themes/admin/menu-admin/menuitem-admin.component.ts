...
import {MenuService} from './menu-admin.service';

@Component({
    selector: '[app-menuitem-admin]',
    template: `
        <ng-container>
            ...
            <ul *ngIf="item.items && item.visible !== false" [@children]="submenuAnimation">
                <ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
                    <li app-menuitem-admin [item]="child" [index]="i" [parentKey]="key" [class]="child.badgeClass"></li>
                </ng-template>
            </ul>
        </ng-container>
    `,
...
export class MenuitemAdminComponent implements OnInit, OnDestroy {
