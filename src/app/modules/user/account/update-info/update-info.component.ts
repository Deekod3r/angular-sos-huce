...
export class UpdateInfoComponent implements OnInit {
    ...
    updateName() {
      ...
      this.userService.updateUser(this.userId, body, 'name').pipe(
    ...
    updatePhone() {
      ...
      this.userService.updateUser(this.userId, body, 'phone').pipe(
        takeUntil(this.subscribes$)
      ).subscribe({
        next: (res) => {
          if (res.success) {
    ...
    updateEmail() {
      ...
      this.userService.updateUser(this.userId, body, 'email').pipe(
        takeUntil(this.subscribes$)
      ).subscribe({
        next: (res) => {
          if (res.success) {
    ...
    verifyUpdateEmail() {
      ...
      this.userService.verifyUpdateEmail(this.formEmailConfirm.value.id, this.formEmailConfirm.value.code).pipe(
        takeUntil(this.subscribes$)
      ).subscribe({
        next: (res) => {
          if (res.success) {
    ...
    updatePassword() {
      ...
      this.userService.updateUser(this.userId, body, 'password').pipe(
        takeUntil(this.subscribes$)
      ).subscribe({
        next: (res) => {
          if (res.success) {
